...
- **LC 1795. Rearrange Products Table** — UNION ALL 反 Pivot -> [link](rearrange_products_table)
- **練習題（自設，模擬幣安原題）**：給定部門表、員工表、專案表、員工專案關聯表，寫出 Top-3 專案最多的部門並以橫向格式輸出 -> [link](binance_interview_pivot_query)
